...
\section{Simulation study of the properties of point estimates and confidence intervals}
...
version using $10^6$. Applying the simulation function, in parallel,
