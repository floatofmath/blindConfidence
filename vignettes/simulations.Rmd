...
mplot <- ggplot(dfa)+
    ...
    facet_grid(variable~method,scale='free_y',labeller=lverbose) +xlab(expression(n[1]))+ylab('')+theme_bw()+xlim(c(2,72))
print(mplot)
...
vplot <- ggplot(dfa,aes(n1,value))+
    ...
    facet_grid(variable~method,scale='free_y',labeller=lverbose(string="Max. variance bias")) +xlab(expression(n[1]))+ylab('Value')+theme_bw()+xlim(c(2,72))
print(vplot)
...
cplot <- ggplot(dfa)+
    ...
    facet_grid(variable~method,scale='free_y',labeller=lverbose(string='Actual - nominal [%]')) +xlab(expression(n[1]))+ylab('Value')+theme_bw()+xlim(c(2,72))
print(cplot)
